...
;(function(global){
     ...
     *      id: "short_name"
     *      name: "short name",
     *      tags: ["active", "test", "empty"],
     *      description: "about the fieldset",
     *      fieldSet: [],
     *   },
     * ]
     */
    ...
    /**
     * SudokuCatalogue starter
     */
    var SudokuCatalogue = function SudokuCatalogue() {
      return new SudokuCatalogue.init();
    };
    SudokuCatalogue.prototype = {
        fieldSets: [],
        /**
         * @param {number} id
         */
        getFieldSetById: function getFieldSetById(id) {
            var self = this;
            var fieldSet = null;
            for(var setIndex in self.fieldSets) {
                if (self.fieldSets[setIndex].id === id) {
                    fieldSet = self.fieldSets[setIndex].fieldSet;
                }
            }
    ...
    SudokuCatalogue.init = function init() {
        var self = this;
